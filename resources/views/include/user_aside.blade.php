    ...
    <div class="data-scrollbar" data-scroll="1">
        <nav class="iq-sidebar-menu">
            <ul id="iq-sidebar-toggle" class="iq-menu">
                ...
                @endif
                @if (check_permission('company') || check_permission('store') || check_permission('area'))
                    <li class=" ">
                ...
                @endif
                @if (check_permission('category') || check_permission('ppe'))
                    <li class=" ">
                ...
                @if (check_permission('category') || check_permission('ppe'))
                    <li class=" ">
                        ...
                        <ul id="people" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                            @if (check_permission('designation'))
                ...
                @if (check_permission('reports.daily') ||
                    ...
                    <li class=" ">
                        ...
                        <ul id="reports" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                            <li class="{{ Route::is('reports.daily') ? 'active' : '' }}">
                                <a href="../backend/page-report.php">
                                    <i class="las la-minus"></i><span>Daily Reports</span>
                                </a>
                            </li>
                            <li class="{{ Route::is('reports.weekly') ? 'active' : '' }}">
                                <a href="../backend/page-add-return.php">
